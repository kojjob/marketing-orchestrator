defmodule GrowthOsWeb.UserLive.ConfirmationTest do
  ...
  describe "Confirm user" do
    ...
    test "confirms the given token once", %{conn: conn, unconfirmed_user: user} do
      ...
      assert Tenancy.get_user!(user.id).confirmed_at
    ...
    test "logs confirmed user in without changing confirmed_at", %{
      ...
      assert Tenancy.get_user!(user.id).confirmed_at == user.confirmed_at
